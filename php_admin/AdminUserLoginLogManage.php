...
var del=new Delete("aSelectAll","AdminUserLoginLogDel.php");
</script>
</head>
...
<div class="title">
	<div class="title1">
		...
		<div class="title1Center">登录日志管理</div>
	</div>
</div>
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	$sql="select * from tbl_adminUserLoginLog order by id desc";
	$adminUserLoginLogData=new AdminUserLoginLogData();
	$arr=$adminUserLoginLogData->listBySql($sql,$page);
	...
	?>
		<tr id="tr<?php echo($i)?>" onMouseOver="javascript:changeTrbk('<?php echo($i);?>');" onMouseOut="javascript:changeTrbk1('<?php echo($i);?>');">
			...
			<td align="center"><?php echo($arr[1][$i]->loginIp);?></td>
			<td align="center"><?php echo($arr[1][$i]->loginTime);?></td>
