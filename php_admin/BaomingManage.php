...
var del=new Delete("aSelectAll","BaomingDel.php");
</script>
</head>
...
<div class="title">
	<div class="title1">
		...
		<div class="title1Center">报名管理</div>
	</div>
</div>
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr class="tdTitle">
		...
		<td align="center"><b>所报专业</b></td>
		<td align="center"><b>提交时间</b></td>
	...
	?>
		<tr id="tr<?php echo($i)?>" onMouseOver="javascript:changeTrbk('<?php echo($i);?>');" onMouseOut="javascript:changeTrbk1('<?php echo($i);?>');">
			...
			<td align="center"><?php echo($arr[1][$i]->major);?></td>
			<td align="center"><?php echo($arr[1][$i]->addtime);?></td>
			<td align="center"><a href="BaomingLook.php?id=<?php echo($arr[1][$i]->id);?>">查看</a>&nbsp;&nbsp;&nbsp;<a href="javascript:del.deleteOne('<?php echo($arr[1][$i]->id);?>','tr<?php echo($i)?>')">删除</a></td>
		</tr>
	<?php
	}
	?>
