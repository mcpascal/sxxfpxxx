...
if($act=="ok"){
	...
	$singlePage=new SinglePage($_POST["singlePageClassId"],$_POST["title"],$_POST["content"],$_POST["sort1"]);
	$singlePageData=new SinglePageData();
	$singlePageData->add($singlePage)?done(1,"SinglePageAdd.php"):done(0);
}
?>
<body>
<div class="title">
	<div class="title1">
		...
		<div class="title1Center">单页面添加</div>
	</div>
</div>
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
		<td align="right" class="tdLeft">页面名称：<span class="red">*</span></td>
	...
	<tr>
		<td align="right" class="tdLeft">排序：<span class="red">*</span></td>
		<td align="left"><input type="text" class="text60" value="50" name="sort1"></td>
	</tr>
	<tr>
		<td></td>
