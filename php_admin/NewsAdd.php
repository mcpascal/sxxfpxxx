...
if($act=="ok"){
	...
	$news=new News($_POST["newsClassId"],$_POST["title"],$_POST["image"],$_POST["content"],$_POST["indexSort"],$_POST["classSort"],$_POST["addTime"]);
	$newsData=new NewsData();
	$newsData->add($news)?done(1,"NewsAdd.php"):done(0);
}
?>
<body>
<div class="title">
	<div class="title1">
		...
		<div class="title1Center">新闻添加</div>
	</div>
</div>
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
		...
		<select name="newsClassId" class="select">
			...
			?>
				<option value="<?php echo($newsClassData->arrAll[$i]->id);?>">
				<?php
