...
function checkForm(obj){
	...
	if(checkValue.checkNull("效果图",obj.image.value))return false;
...
if($act=="ok"){
	...
	$product=new Product($_POST["productClassId"],$_POST["title"],$_POST["image"],$_POST["content"],$_POST["indexSort"],$_POST["classSort"],$_POST["addTime"]);
	$productData=new ProductData();
	$productData->add($product)?done(1,"ProductAdd.php"):done(0);
}
?>
<body>
<div class="title">
	<div class="title1">
		...
		<div class="title1Center">产品添加</div>
	</div>
</div>
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
		...
		<select name="productClassId" class="select">
			...
			?>
				<option value="<?php echo($productClassData->arrAll[$i]->id);?>">
				<?php
	...
	<tr>
		...
		<td align="left"><input type="text" class="text" value="" name="title"></td>
	</tr>
	<tr>
	...
	<!--<tr>
		...
		<td align="left" style="padding:3px;"><textarea name="content" style="width:700px;height:500px;visibility:hidden;"></textarea></td>
	</tr>-->
	<tr>
		<td align="right" class="tdLeft">首页排序：<span class="red">*</span></td>
		<td align="left"><input type="text" class="text" value="100" name="indexSort"></td>
	</tr>
	<tr>
		<td align="right" class="tdLeft">本类排序：<span class="red">*</span></td>
		<td align="left"><input type="text" class="text" value="100" name="classSort"></td>
	</tr>
	<tr style="display:none">
		<td align="right" class="tdLeft">添加时间：</td>
	  	<td align="left"><input type="text" name="addTime" class="text60" style="width:70px;" value="<?php echo(date("Y-m-d"))?>" readonly="true" onFocus="new Calendar().show(this)"></td>
	</tr>	
	<tr>
		<td></td>
