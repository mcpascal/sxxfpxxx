...
var del=new Delete("aSelectAll","NewsDel.php");
</script>
</head>
...
<div class="title">
	<div class="title1">
		...
		<div class="title1Center">新闻管理</div>
	</div>
</div>
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	?>
		<tr id="tr<?php echo($i)?>" onMouseOver="javascript:changeTrbk('<?php echo($i);?>');" onMouseOut="javascript:changeTrbk1('<?php echo($i);?>');">
			...
			$arr1=$newsClassData->getInfoById($arr[1][$i]->newsClassId);
			...
			<td align="center" style="padding-right:20px;"><a href="NewsChange.php?id=<?php echo($arr[1][$i]->id);?>">修改</a>&nbsp;&nbsp;<a href="javascript:del.deleteOne('<?php echo($arr[1][$i]->id);?>','tr<?php echo($i)?>')">删除</a></td>
		</tr>
	<?php
	}
	?>
