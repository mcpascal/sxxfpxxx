...
<title>在线注册-<?php echo($webSetting->webName)?></title>
		...
		<Div class="main-2">
			<div class="right-da">
				<div class="right-top" style="width:100%;">
					<div class="right-biao">在线注册</div>
					<div class="home"><img src="images/home.gif" />&nbsp;&nbsp;您当前位置：网站首页 > 在线注册</div>
				</div>
			  <div class="right-main-da">
					<form action="?act=ok" method="post" onsubmit="return checkForm(this)">
						<table width="78%" height="750" border="0" align="center">
						  <tr>
						  ...
						  <tr>
							...
							<td>
							  <table cellpadding="0" cellspacing="0" border="0"><tr><td><input name="code" type="text"  size="5"/></td><td valign="middle"><img src="code.php?<?php echo(rand(0,999))?>" onClick="javascript:this.src=this.src+'?'+Math.random();" alt="看不清？点击图片更换下一张" style="margin-left:10px;" /><span style="color:#FF0000;">*</span></td></tr></table>
							</td>
						  </tr>
						  <tr>
							<td>&nbsp;</td>
