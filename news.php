...
?>
<title><?php echo($className)?>-学校动态-<?php echo($webSetting->webName)?></title>
...
<div class="main">
	<div class="main-1">
		...
		?>
		<Div class="main-2">
			<div class="left"><img src="images/left-top-1.gif" />
				<div class="left-k">
					<ul>
					<?php
					$newsClassData=new NewsClassData();
			...
			<div class="right">
				<div class="right-top">
					...
					<div class="home"><img src="images/home.gif" />&nbsp;&nbsp;您当前位置：网站首页 > 学校动态 > <?php echo $className; ?></div>
				</div>
